...
public class Publisher {
    ...
    public Publisher(String[] properties) {
        ...
        propertyListeners = Collections.synchronizedMap(new HashMap<String, List<IPropertyListener>>());

        // Register null-String as property
        propertyListeners.put(null, Collections.synchronizedList(new ArrayList<IPropertyListener>()));
        
        // Register remaining properties
        for (String s : properties) {
            propertyListeners.put(s, Collections.synchronizedList(new ArrayList<IPropertyListener>()));
        }
    ...
    private void unsubscribeListener(IPropertyListener listener, String property) {
        if (property != null) {
             ...
             * to an ArrayList.
             */
            List<String> keyset = new ArrayList<String>(propertyListeners.keySet());
    ...
    public void inform(String property, Object oldValue, Object newValue) {
        ...
        listenersToBeInformed = new ArrayList<IPropertyListener>();
    ...
    public void registerProperty(String property) {
        ...
        propertyListeners.put(property, Collections.synchronizedList(new ArrayList<IPropertyListener>()));
    ...
    public List<String> getProperties() {
        List<String> properties = new ArrayList<String>(propertyListeners.keySet());
